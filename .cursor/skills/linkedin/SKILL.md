---
name: linkedin
description: Draft LinkedIn posts in Jo's voice. Use when the user asks for a LinkedIn post, a career update, a reflection, or a lessons-learned writeup.
model: Opus 4.7 Low Fast
---

# LinkedIn posts

Voice: first person, conversational, short paragraphs, specific names and numbers, humble and gracious. 150 to 250 words before hashtags. Follow the repo writing-style rule.
